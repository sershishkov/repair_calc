...
import { bankincome__add } from '../../../../features/accounting/accountant/bankincome/bankincome__Slice';
...
const AddBankIncome = () => {
  ...
  const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    dispatch(bankincome__add(created__Data));
  };
