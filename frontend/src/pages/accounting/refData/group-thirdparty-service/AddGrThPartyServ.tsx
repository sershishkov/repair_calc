...
import { grThirdPartyService__add } from '../../../../features/accounting/refData/group-thirdparty-service/grThirdpartyService__Slice';
...
function AddGrThPartyServ() {
  ...
  const onSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    dispatch(grThirdPartyService__add(created__Data));
  };
...
export default AddGrThPartyServ;
